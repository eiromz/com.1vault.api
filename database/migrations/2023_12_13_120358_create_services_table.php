...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('services', function (Blueprint $table) {
            ...
            $table->string('title');
            $table->string('type')->comment('this can be utility,airtime,internet electricity,social_media_subscription,service.legal');
            ...
            $table->string('billing_cycle')->comment('this is how the queue job will charge the subscription plan');
